...
const KarcisList = ()=>{
    ...
    const fetcher2 = async(id)=>{
        const socket2 = new WebSocket('ws://antrian-online.onrender.com/antrian/v1/loket/user-id');
        socket2.onclose = () => {
    ...
    useEffect(()=>{
        axios.get("http://antrian-online.onrender.com/antrian/v1/tipe_pasien/list").then((res)=>{
